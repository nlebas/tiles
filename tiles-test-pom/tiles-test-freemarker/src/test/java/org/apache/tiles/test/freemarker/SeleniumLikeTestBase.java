...
import org.apache.tiles.guice.renderer.FreemarkerRendererModule;
...
public class SeleniumLikeTestBase {
    ...
    public static void setUp() {
        ...
        GuiceTilesInitializer tilesAlternateInitializer = new GuiceTilesInitializer(
                ...
                new FreemarkerRendererModule(), new ReverseStringModule());
    ...
    protected final void clickAndWait(String path) throws IOException {
        ...
        output = "";
        FreemarkerRenderer renderer = (FreemarkerRenderer) applicationContext.getApplicationScope().get(
